...
var symbolsCaseCode = arrayLowToHigh(32, 47).concat(arrayLowToHigh(58, 64)).concat(arrayLowToHigh(91, 96)).concat(arrayLowToHigh(58, 64)).concat(arrayLowToHigh(123, 126));
...
function generateCharArray(){
  ...
  console.log(charArray)
  if(symbols.checked === false && numbers.checked === false && lowercase.checked === false && uppercase.checked === false){
    charArray = charArray.concat(lowerCaseCode)
  }
  console.log(charArray)
